...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Package sur Analyse de T Test",
    Description = "Package contenant différentes fonctions utiles pour l'analyse de T Test.",
    `Authors@R` = c(
      person("Oumar", "Barry", email = "alphadjobarry999@gmail.com", role = c("aut", "cre"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Oumar Barry")
```
