...
```{r development-bio_analyze_t_test}
# You can prepare the code of the bio_analyze_t_test() function here
```
  
```{r function-bio_analyze_t_test}
...
fusen::inflate(flat_file = "dev/flat_TTest.Rmd", vignette_name = "Fonctions T Test")
```
